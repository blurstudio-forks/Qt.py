...
```
  membership-begin: OK (0.12=setup[0.06]+cmd[0.06] seconds)
  membership-2020-PySide2: OK (0.38=setup[0.08]+cmd[0.03,0.27] seconds)
  membership-2020-PyQt5: OK (0.00 seconds)
  membership-2021-PySide2: OK (0.33=setup[0.00]+cmd[0.05,0.28] seconds)
  membership-2021-PyQt5: OK (0.00 seconds)
  membership-2022-PySide2: OK (0.33=setup[0.00]+cmd[0.05,0.28] seconds)
  membership-2022-PyQt5: OK (0.27=setup[0.02]+cmd[0.03,0.22] seconds)
  membership-2023-PySide2: OK (0.42=setup[0.06]+cmd[0.06,0.30] seconds)
  membership-2023-PyQt5: OK (0.28=setup[0.03]+cmd[0.03,0.22] seconds)
  membership-2024-PySide6: OK (0.58=setup[0.05]+cmd[0.05,0.49] seconds)
  membership-2024-PyQt6: OK (0.25=setup[0.00]+cmd[0.05,0.20] seconds)
  membership-end: OK (0.58=setup[0.00]+cmd[0.58] seconds)
...
```bash
tox -e membership-2024-PySide6
```

Running multiple tests:
```bash
tox -e membership-begin,membership-2024-PySide6,membership-2024-PyQt6,membership-end
```
This would run 4 tests in the order described.
...
generating a list of bindings for PySide6 and PyQt6 for a VFX Platform. The
...
- `membership-end` combines the data generated by each `membership-*-*` into the final common members dictionary for all Qt versions as well as per-major Qt version. It also creates some reference .csv/.md files to make it easy to see all possible members and which bindings implement them.
